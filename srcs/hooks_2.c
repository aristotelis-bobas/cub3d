...
/*   Updated: 2020/02/03 18:32:12 by abobas        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	rotate_left(t_data *data)
{
	...
	data->dir_x = data->dir_x * cos(-0.03) - data->dir_y * sin(-0.03);
	data->plane_x = data->plane_x * cos(-0.03) - data->plane_y * sin(-0.03);
	data->dir_y = data->dir_x_old * sin(-0.03) + data->dir_y * cos(-0.03);
	data->plane_y = data->plane_x_old * sin(-0.03) + data->plane_y * \
	cos(-0.03);
}
...
void	rotate_right(t_data *data)
{
	...
	data->dir_y = data->dir_x_old * sin(0.03) + data->dir_y * cos(0.03);
	data->plane_x = data->plane_x * cos(0.03) - data->plane_y * sin(0.03);
	data->plane_y = data->plane_x_old * sin(0.03) + data->plane_y * cos(0.03);
}
