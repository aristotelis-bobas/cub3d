...
/*   Updated: 2020/02/02 22:25:25 by abobas        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	answer_small(t_map *map, char c)
{
	...
	else if (c == '3')
	{
		...
		ft_putstr("\nWindow resolution has not been adjusted.\n");
}
...
void	choice_small(t_map *map)
{
	...
	c = 'x';
	ft_putstr("Small window resolution detected.\n");
	ft_putstr("Would you like to adjust the window resolution?\n");
	...
	ft_putstr("Enter '0' to keep current settings.\n\n");
